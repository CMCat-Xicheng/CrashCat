...
public class NameProtect extends Module {
    ...
    private final TextValue fakeNameValue = new TextValue("FakeName", "&b&lCMCat");
    private final TextValue allFakeNameValue = new TextValue("AllPlayersFakeName", "CrashCat");
